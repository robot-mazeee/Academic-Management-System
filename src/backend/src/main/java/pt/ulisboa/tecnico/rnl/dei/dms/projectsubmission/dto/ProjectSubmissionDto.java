...
public record ProjectSubmissionDto(long id, Project project, Group group, LocalDateTime subDateTime, double grade, String submission) {
    public ProjectSubmissionDto(ProjectSubmission projectSubmission) {
        this(
            ...
            projectSubmission.getSubmission()
        );
    }
}